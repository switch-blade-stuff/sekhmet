...
namespace sek::detail
{
	...
	class basic_hash_table : ebo_base_helper<Allocator>,
	...
	private:
		...
		[[nodiscard]] constexpr static size_type apply_load_factor(size_type value) noexcept { return value * 10 / 16; }
	...
	public:
		...
		constexpr basic_hash_table(basic_hash_table &&other) noexcept(nothrow_alloc_move_construct<value_allocator_type, bucket_allocator_type>)
		...
		constexpr basic_hash_table &
			operator=(basic_hash_table &&other) noexcept(nothrow_alloc_move_assign<value_allocator_type, bucket_allocator_type>)
		{
