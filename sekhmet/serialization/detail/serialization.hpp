...
{
	constexpr bool base64_decode(void *dest, std::size_t size, const char *chars, std::size_t len) noexcept
	{
	...
	constexpr std::size_t base64_encode(const void *data, std::size_t size, char *chars) noexcept
	{
