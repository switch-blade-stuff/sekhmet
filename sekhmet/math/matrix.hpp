...
namespace sek::math
{
	...
	template<typename T = float>
	using mat4x4_packed = basic_mat<T, 4, 4, storage_policy::SIZE>;
	template<typename T = float>
	using mat4x3_packed = basic_mat<T, 4, 3, storage_policy::SIZE>;
	template<typename T = float>
	using mat4x2_packed = basic_mat<T, 4, 2, storage_policy::SIZE>;
	template<typename T = float>
	using mat3x4_packed = basic_mat<T, 3, 4, storage_policy::SIZE>;
	template<typename T = float>
	using mat3x3_packed = basic_mat<T, 3, 3, storage_policy::SIZE>;
	template<typename T = float>
	using mat3x2_packed = basic_mat<T, 3, 2, storage_policy::SIZE>;
	template<typename T = float>
	using mat2x4_packed = basic_mat<T, 2, 4, storage_policy::SIZE>;
	template<typename T = float>
	using mat2x3_packed = basic_mat<T, 2, 3, storage_policy::SIZE>;
	template<typename T = float>
	using mat2x2_packed = basic_mat<T, 2, 2, storage_policy::SIZE>;
	template<typename T = float>
