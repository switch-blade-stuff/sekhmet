...
namespace sek
{
	...
	template<typename T = float>
	using mat4x4_packed = basic_mat<T, 4, 4, policy_t::DEFAULT_PACKED>;
	template<typename T = float>
	using mat4x3_packed = basic_mat<T, 4, 3, policy_t::DEFAULT_PACKED>;
	template<typename T = float>
	using mat4x2_packed = basic_mat<T, 4, 2, policy_t::DEFAULT_PACKED>;
	template<typename T = float>
	using mat3x4_packed = basic_mat<T, 3, 4, policy_t::DEFAULT_PACKED>;
	template<typename T = float>
	using mat3x3_packed = basic_mat<T, 3, 3, policy_t::DEFAULT_PACKED>;
	template<typename T = float>
	using mat3x2_packed = basic_mat<T, 3, 2, policy_t::DEFAULT_PACKED>;
	template<typename T = float>
	using mat2x4_packed = basic_mat<T, 2, 4, policy_t::DEFAULT_PACKED>;
	template<typename T = float>
	using mat2x3_packed = basic_mat<T, 2, 3, policy_t::DEFAULT_PACKED>;
	template<typename T = float>
	using mat2x2_packed = basic_mat<T, 2, 2, policy_t::DEFAULT_PACKED>;
	template<typename T = float>
