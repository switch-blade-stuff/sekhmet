...
namespace sek::math
{
	...
	public:
		...
		constexpr basic_mat(const basic_vec<T, 2, Sp> &c0,
							   ...
							   const basic_vec<T, 2, Sp> &c2) noexcept
	...
	[[nodiscard]] constexpr basic_mat<T, 2, 2, P> operator*(const basic_mat<T, 3, 2, P> &l,
															   const basic_mat<T, 2, 3, P> &r) noexcept
	{
	...
	template<typename T, storage_policy P>
	[[nodiscard]] constexpr basic_mat<T, 3, 2, P> operator*(const basic_mat<T, 3, 2, P> &l,
															   const basic_mat<T, 3, 3, P> &r) noexcept
	{
		const auto r0 = l.row(0);
		const auto r1 = l.row(1);
		const auto &c0 = r.col(0);
	...
	template<typename T, storage_policy P>
	[[nodiscard]] constexpr basic_mat<T, 4, 2, P> operator*(const basic_mat<T, 3, 2, P> &l,
															   const basic_mat<T, 4, 3, P> &r) noexcept
	{
		const auto r0 = l.row(0);
		const auto r1 = l.row(1);
		const auto &c0 = r.col(0);
	...
	template<typename T, storage_policy P>
	[[nodiscard]] constexpr basic_vec<T, 2, P> operator*(const basic_mat<T, 3, 2, P> &m,
															const basic_vec<T, 3, P> &v) noexcept
	{
		return m[0] * v[0] + m[1] * v[1] + m[2] * v[2];
	}
	template<typename T, storage_policy P>
	[[nodiscard]] constexpr basic_vec<T, 3, P> operator*(const basic_vec<T, 2, P> &v,
															const basic_mat<T, 3, 2, P> &m) noexcept
	{
		return basic_vec<T, 3, P>{dot(v, m[0]), dot(v, m[1]), dot(v, m[2])};
	}

	template<typename T, std::size_t N, std::size_t M, storage_policy Sp>
	[[nodiscard]] constexpr basic_mat<T, 2, 3, Sp> transpose(const basic_mat<T, 3, 2, Sp> &m) noexcept
	{
		const auto r0 = m.row(0);
		const auto r1 = m.row(1);
		return basic_mat<T, 2, 3, Sp>{r0, r1};
	}
	...
	public:
		...
		constexpr basic_mat(const basic_vec<T, 3, Sp> &c0,
							   ...
							   const basic_vec<T, 3, Sp> &c2) noexcept
			: m_data{col_type{c0}, col_type{c1}, col_type{c2}}
		{
		}
	...
	template<typename T, storage_policy P>
	[[nodiscard]] constexpr basic_mat<T, 2, 3, P> operator*(const basic_mat<T, 3, 3, P> &l,
															   const basic_mat<T, 2, 3, P> &r) noexcept
	{
		const auto r0 = l.row(0);
		const auto r1 = l.row(1);
	...
	template<typename T, storage_policy P>
	[[nodiscard]] constexpr basic_mat<T, 3, 3, P> operator*(const basic_mat<T, 3, 3, P> &l,
															   const basic_mat<T, 3, 3, P> &r) noexcept
	{
		const auto r0 = l.row(0);
		const auto r1 = l.row(1);
	...
	template<typename T, storage_policy P>
	[[nodiscard]] constexpr basic_mat<T, 4, 3, P> operator*(const basic_mat<T, 3, 3, P> &l,
															   const basic_mat<T, 4, 3, P> &r) noexcept
	{
		const auto r0 = l.row(0);
		const auto r1 = l.row(1);
	...
	template<typename T, std::size_t N, std::size_t M, storage_policy Sp>
	[[nodiscard]] constexpr basic_mat<T, 3, 3, Sp> transpose(const basic_mat<T, 3, 3, Sp> &m) noexcept
	{
		const auto r0 = m.row(0);
		const auto r1 = m.row(1);
		const auto r2 = m.row(2);
		return basic_mat<T, 3, 3, Sp>{r0, r1, r2};
	}
	...
	public:
		...
		constexpr basic_mat(const basic_vec<T, 4, Sp> &c0,
							   ...
							   const basic_vec<T, 4, Sp> &c2) noexcept
			: m_data{col_type{c0}, col_type{c1}, col_type{c2}}
		{
		}
	...
	template<typename T, storage_policy P>
	[[nodiscard]] constexpr basic_mat<T, 2, 4, P> operator*(const basic_mat<T, 3, 4, P> &l,
															   const basic_mat<T, 2, 3, P> &r) noexcept
	{
		const auto r0 = l.row(0);
		const auto r1 = l.row(1);
	...
	template<typename T, storage_policy P>
	[[nodiscard]] constexpr basic_mat<T, 3, 4, P> operator*(const basic_mat<T, 3, 4, P> &l,
															   const basic_mat<T, 3, 3, P> &r) noexcept
	{
		const auto r0 = l.row(0);
		const auto r1 = l.row(1);
	...
	template<typename T, storage_policy P>
	[[nodiscard]] constexpr basic_mat<T, 4, 4, P> operator*(const basic_mat<T, 3, 4, P> &l,
															   const basic_mat<T, 4, 3, P> &r) noexcept
	{
		const auto r0 = l.row(0);
		const auto r1 = l.row(1);
	...
	template<typename T, storage_policy P>
	[[nodiscard]] constexpr basic_vec<T, 4, P> operator*(const basic_mat<T, 3, 4, P> &m,
															const basic_vec<T, 3, P> &v) noexcept
	{
		return m[0] * v[0] + m[1] * v[1] + m[2] * v[2];
	}
	template<typename T, storage_policy P>
	[[nodiscard]] constexpr basic_vec<T, 3, P> operator*(const basic_vec<T, 4, P> &v,
															const basic_mat<T, 3, 4, P> &m) noexcept
	{
		return basic_vec<T, 3, P>{dot(v, m[0]), dot(v, m[1]), dot(v, m[2])};
	}

	template<typename T, std::size_t N, std::size_t M, storage_policy Sp>
	[[nodiscard]] constexpr basic_mat<T, 4, 3, Sp> transpose(const basic_mat<T, 3, 4, Sp> &m) noexcept
	{
		const auto r0 = m.row(0);
		const auto r1 = m.row(1);
		const auto r2 = m.row(2);
		const auto r3 = m.row(3);
		return basic_mat<T, 4, 3, Sp>{r0, r1, r2, r3};
	}
}	 // namespace sek::math