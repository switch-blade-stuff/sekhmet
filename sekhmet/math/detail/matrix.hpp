...
public:                                                                                                                \
	...
	typedef basic_vector<T, M, P> col_type;                                                                            \
	typedef basic_vector<T, N, P> row_type;                                                                            \
                                                                                                                       \
...
namespace sek::math
{
	...
	[[nodiscard]] constexpr hash_t hash(const basic_matrix<T, N, M, Sp> &m) noexcept
	{
		hash_t result = 0;
		// clang-format off
	...
	template<typename T, std::size_t N, std::size_t M, storage_policy Sp>
	constexpr void swap(basic_matrix<T, N, M, Sp> &a, basic_matrix<T, N, M, Sp> &b) noexcept
	{
		a.swap(b);
	}
	...
	template<typename T, std::size_t N, std::size_t M, storage_policy Sp>
	[[nodiscard]] constexpr basic_matrix<T, M, N, Sp> transpose(const basic_matrix<T, N, M, Sp> &m) noexcept
	{
		basic_matrix<T, M, N, Sp> result;
	...
	template<typename T, std::size_t N, std::size_t M, storage_policy Sp>
	[[nodiscard]] constexpr basic_matrix<T, N, M, Sp> operator+(const basic_matrix<T, N, M, Sp> &l,
																const basic_matrix<T, N, M, Sp> &r) noexcept
	{
		basic_matrix<T, N, M, Sp> result;
		for (std::size_t i = 0; i < N; ++i) result[i] = l[i] + r[i];
		return result;
	}
	/** Adds a matrix to a matrix. */
	template<typename T, std::size_t N, std::size_t M, storage_policy Sp>
	constexpr basic_matrix<T, N, M, Sp> &operator+=(basic_matrix<T, N, M, Sp> &l, const basic_matrix<T, N, M, Sp> &r) noexcept
	{
	...
	template<typename T, std::size_t N, std::size_t M, storage_policy Sp>
	[[nodiscard]] constexpr basic_matrix<T, N, M, Sp> operator*(const basic_matrix<T, N, M, Sp> &l, T r) noexcept
	{
		basic_matrix<T, N, M, Sp> result;
	...
	/** @copydoc operator* */
	template<typename T, std::size_t N, std::size_t M, storage_policy Sp>
	[[nodiscard]] constexpr basic_matrix<T, N, M, Sp> operator*(T l, const basic_matrix<T, N, M, Sp> &r) noexcept
	{
		return r * l;
	}
	/** Multiplies matrix by a scalar. */
	template<typename T, std::size_t N, std::size_t M, storage_policy Sp>
	constexpr basic_matrix<T, N, M, Sp> &operator*=(basic_matrix<T, N, M, Sp> &l, T r) noexcept
	{
	...
	template<typename T, std::size_t N, std::size_t M, storage_policy Sp>
	[[nodiscard]] constexpr basic_matrix<T, N, M, Sp> operator~(const basic_matrix<T, N, M, Sp> &m) noexcept
	{
		basic_matrix<T, N, M, Sp> result;
	...
	[[nodiscard]] constexpr basic_matrix<T, C1, R0, Sp> operator*(const basic_matrix<T, C0, R0, Sp> &l,
																  const basic_matrix<T, C1, C0, Sp> &r) noexcept
	{
		basic_matrix<T, C1, R0, Sp> result = {};
	...
	template<typename T, std::size_t N, std::size_t M, storage_policy Sp>
	[[nodiscard]] constexpr basic_vector<T, M> operator*(const basic_matrix<T, N, M, Sp> &m, const basic_vector<T, N, Sp> &v) noexcept
	{
	...
	[[nodiscard]] constexpr basic_vector<T, C1, Sp> operator*(const basic_vector<T, C0, Sp> &v,
															  const basic_matrix<T, C1, C0, Sp> &m) noexcept
	{
	...
	[[nodiscard]] constexpr typename basic_matrix<T, N, M, Sp>::col_type &get(basic_matrix<T, N, M, Sp> &m) noexcept
	{
		return m[I];
	}
	/** @copydoc get */
	template<std::size_t I, typename T, std::size_t N, std::size_t M, storage_policy Sp>
	[[nodiscard]] constexpr const typename basic_matrix<T, N, M, Sp>::col_type &get(const basic_matrix<T, N, M, Sp> &m) noexcept
	{
		return m[I];
	}
	...
	[[nodiscard]] constexpr T &get(basic_matrix<T, N, M, Sp> &m) noexcept
	{
		return m[I][J];
	}
	template<std::size_t I, std::size_t J, typename T, std::size_t N, std::size_t M, storage_policy Sp>
	[[nodiscard]] constexpr const T &get(const basic_matrix<T, N, M, Sp> &m) noexcept
	{
		return m[I][J];
	}
}	 // namespace sek::math
...
struct std::tuple_size<sek::math::basic_matrix<T, N, M, Sp>> : std::integral_constant<std::size_t, N>
{
};
template<std::size_t I, typename T, std::size_t N, std::size_t M, sek::math::storage_policy Sp>
struct std::tuple_element<I, sek::math::basic_matrix<T, N, M, Sp>>
{
	using type = typename sek::math::basic_matrix<T, N, M, Sp>::col_type;
};
