...
~/CekhmetProjects/my_project
    ...
    -> plugins                      (Directory containing plugin sub-projects)
        shared.cmake                (Cmake include file containing shared configuration for plugin projects)
...
point to a valid object, the resource is loaded and deserialized from it's asset.
...
This extended information is then used to
